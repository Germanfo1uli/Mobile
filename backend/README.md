...
Облачная панель состояния: `https://althunt-api.vercel.app/`. Она отображает безопасную
сводку по базе и ведёт в Neon Console, где после входа доступны таблицы и SQL Editor.
...
| `GET` | `/api/monitoring/summary` | Сводные счётчики для публичной панели без персональных данных |
