...
Серверная часть лабораторных 4–6: игровые раунды, проверка попаданий, сохранение
результатов и бонус наклона. Контракт и примеры находятся в [docs/labs-4-6.md](docs/labs-4-6.md).
Новые игровые методы пока не подключены к Android-интерфейсу.
